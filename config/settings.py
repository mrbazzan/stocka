...
#  I use Postqresql for the database
...
# EMAIL
# Email Account: fayomide@gmail.com
...
EMAIL_PORT = 587
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')  # 'ogtconsult21@gmail.com'
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')  # "yywularwtjnqmkwb"
EMAIL_USE_TLS = True
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        'user_delete': 'apis.serializers.UserDeleteSerializer',
    },
}
